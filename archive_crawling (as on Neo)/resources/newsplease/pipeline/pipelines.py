...
# import sys
import dateparser
from python.resources.newsplease.NewsArticle import NewsArticle
...
class ExtractedInformationStorage:
    ...
    @staticmethod
    def ensure_str(text):
        """Ensures the text has the String type."""
    ...
    def extract_relevant_info(item):
        ...
        article = {
            ...
            item['article_title'],
            'title_page':
            ExtractedInformationStorage.ensure_str(item['html_title']),
            'title_rss':
            ExtractedInformationStorage.ensure_str(item['rss_title']),
            'source_domain':
    ...
    def datestring_to_date(text):
        """Extracts a datetime object from a date string."""
        if text:
    ...
    def convert_to_class(item):
        """Returns a NewsArticle class of the extracted data."""
